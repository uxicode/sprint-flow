...
export const getTicketLink = (key, jiraUrl) => {
...
export const getStatusCategory = (statusName) => {
...
export const parseVacationEvent = (summary) => {
...
export const isEventOverlapping = (evtStart, evtEnd, startRange, endRange) => {
...
export const getMemberVacationDates = (events, member, startRange, endRange) => {
...
export const getVacationMembers = (events, startDate, endDate, registered) => {
